...
echo 'retweet'
echo '	1st Order Random Walk'
python __main__.py --format mat --matfile-variable-name adjacency_matrix --input ../data/sample/retweet_list_baseline.mat --output ../embedding/retweet/random_walk_1.embeddings --order 1 --workers 5
echo '	2nd Order Random Walk'
python __main__.py --format mat --matfile-variable-name adjacency_matrix --input ../data/sample/retweet_list_baseline.mat --output ../embedding/retweet/random_walk_2.embeddings --order 2 --workers 5
echo '	BFS+DFS'
python __main__.py --format mat --matfile-variable-name adjacency_matrix --input ../data/sample/retweet_list_baseline.mat --output ../embedding/retweet/bfs_dfs_random_walk.embeddings --bfsdfs True --bfs_p 4 --dfs_q 2 --workers 5
